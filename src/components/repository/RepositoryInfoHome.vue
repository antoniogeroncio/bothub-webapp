<template>
  <div>
    <div class="bh-grid bh-grid--column repository-info--center">
      <div class="bh-grid__item repository-info__big-badge-wrapper">
      ...
      <div class="bh-grid__item bh-grid bh-grid--column repository-info--center">
